...
`,
    ...
    for the disease (these people are outlined in white). As the Sensitivity is \\(90\\%\\), we know that \\(90\\%\\) of the 
...
`,
  ...
  About: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et arcu tincidunt, vestibulum erat vel, dignissim velit. Aliquam non libero tempus, pharetra risus vehicula, tincidunt elit. Etiam porttitor urna sed lacinia pellentesque. Donec pharetra mi quis gravida iaculis. Quisque hendrerit consequat elementum. Proin dolor ante, egestas in tellus ac, iaculis hendrerit nisl. Aliquam eget lacus mollis, fringilla erat sed, rhoncus mauris. Integer vitae urna viverra, condimentum ligula aliquam, sollicitudin dui. Mauris aliquet malesuada porttitor. Nam ac neque varius, fermentum felis nec, vestibulum sem. Cras ante nisi, porta at lobortis id, aliquam efficitur odio. Sed tristique urna sit amet neque mollis, et faucibus leo dapibus. Praesent tincidunt ultricies enim. Pellentesque ac diam erat.`,
};
